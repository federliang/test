...
@implementation SMSPreviewViewController
...
//																			  action:@selector(rightButtonAction)] autorelease];
	self.navigationItem.rightBarButtonItem = [[[UIBarButtonItem alloc] initWithTitle:@"load chat log" 
																			  style:UIBarButtonItemStyleBordered
																			 target:self
																			 action:@selector(loadAction)] autorelease];
...
//	}
	...
	NSLog(@"pick Number = %@", MySingleton.retriveSingletion.someProperty);
	return YES;
}
